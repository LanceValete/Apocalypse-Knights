...
def choices():
        # Calls materials and player_hp variables
        global materials
        global player_hp
        
        # prints the menu for the player to see
        ...
        # player enters input here
        choice = num_check('Enter your choice: ', 1, 5)
        
        # Choice 1: Lure away Enemies
        if (choice == 1):
            # General Statement
            ...
            if random.random() < 0.2:
                ...
                # Okay scenario
                # 40% chance for success with some loss in loot
                materials_lost = 6
            ...
            # 40% chance for failed scavenge - sends player back to base and some loss in HP
            else:
                # Losing scenario
                HP_loss = 3
        ...
        if (choice == 2):
            ...
            if random.random() < 0.2:
                ...
                # Okay scenario
                # 40% chance for success with some loss in player_hp
                HP_loss = 3
                player_hp = player_hp - HP_loss
        ...
        if (choice == 3):
            ...
            if random.random() < 0.5:
                # Success scenario
                # 50% chance for total success
                print("You were able to sneak past the enemies")
                print("You sly dog...")
                print('You can now scavenge')
                # Put scavenging function here

            # 50% chance for failed scavenge
            # Sends player back to base and some loss in HP and loot
            else:
                # Losing scenario
                materials_lost = 8
                materials = materials - materials_lost
        ...
        if (choice == 4):
            ...
            # If the scenario is calm then let player by
        ...
        # Sends the player back to base menu
        if (choice == 5):
